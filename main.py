...
#     parser.add_argument('-la', '--reg_lambda', type=float, default=0.01, help='Regularization parameter for uncertainty sampling')
...
#                      acquisition_function=args.acquisition_function, reg_lambda=args.reg_lambda, steps=args.steps, epochs=args.epochs, samples_per_step=args.samples_per_step, sampling_method=args.sampling_method, validation_size=args.validation_size, topk=args.topk, # Active learning parameters
