...
results = Parallel(n_jobs=-1)(
    delayed(process_combination)(model_name, combo, sensors, steps, epochs, directory, plot) 
    for model_name, combo in tqdm(all_combinations, desc="Processing combinations")
)
