...
class BayesianNetwork(nn.Module):
    def __init__(self, input_dim, hidden_size):
        ...
        self.blinear1 = BayesianLinear(input_dim, hidden_size, prior_sigma_1=5)
        self.blinear2 = BayesianLinear(hidden_size, hidden_size, prior_sigma_1=5)
        self.blinear3 = BayesianLinear(hidden_size, 1, prior_sigma_1=5)
